...
out_angles&
    ...
    !        set_passive, &         ! calculate passive stuff (with RT4)
    !        set_use_rain_db, &
    !        set_use_snow_db
    !
    ...
    interface
        ...
        subroutine run_rt(err,nx,ny,fi)
            use kinds
            implicit none
    ...
    if (verbose >= 2) print*,in_freqs, in_nlyrs, max_in_nlyrs
    ...
    if (verbose >= 2) print*, 'Start loop over frequencies & profiles!'
