...
!****************************************************************** 
  use kinds
      ...
      REAL(kind=dbl) F, Pbkpa, Ekpa, Tc, W, ABSCOF 
...
! For OXYGEN                                                            
      ...
      DO 10 I = 1, 44 
         ...
         * 1.E-3                                                        
         ...
         ZF = F / F0O2 (I) * (CMPLX (1., - DELTA) / CMPLX (F0O2 (I)     &
         - F, - GAMMA) - CMPLX (1., DELTA) / CMPLX (F0O2 (I) + F, GAMMA)&
         )                                                              
         ZN = ZN + S * ZF 
   10 END DO 
...
! Doppler approximation.                                                
         ...
         DELH = 0. 
         ZF = F / F0H2O (I) * (CMPLX (1., - DELH) / CMPLX (F0H2O (I)    &
         - F, - GAMH) - CMPLX (1., DELH) / CMPLX (F0H2O (I) + F, GAMH) )
         ZN = ZN + S * ZF 
   20 END DO 
...
! Complex Permittivity of water (double-Debye model)                    
         ZEp = Eps - f * ( (Eps - Epinf) / CMPLX (f, fD) + (Epinf -     &
         Eopt) / CMPLX (f, fS) )                                        
!                                                                       
! ICE PERMITTIVITY [8]                                                  
      ELSE 
