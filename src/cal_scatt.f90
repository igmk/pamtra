...
!      WRITE(*,*)'CAL-SCATT',swc,NUM_0,LAMBDA_0
      ...
      OPEN(1232,FILE='xinxin_scatmat.dat',&
...
!print*, TEMPERATURE,FREQUENCY, PARTICLE_SIZE,snow_ref
...
print*, IC, PARTICLE_SIZE, num_0,lambda_0,NUM_0*EXP(-LAMBDA_0*PARTICLE_SIZE)*bin_size,snow_ref
