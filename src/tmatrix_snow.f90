subroutine tmatrix_snow(f, wc, t, nc, &
  ...
  do ir = 1, nbins
     ...
     particle_mass = a_m*diameter**b ! particle mass [kg]
!         IF (diameter*1.e6.GE.0.005E4.AND.diameter*1.e6.LE.0.2E4)THEN ! 50um~200um
!            PARTICLE_MASS = 0.003D0*(diameter*1.e6/1.0E4)**2.0D0*1.e-3
!         ELSEIF (diameter*1.e6.GT.0.2E4.AND.diameter*1.e6.LE.2.0E4)THEN ! 200um~2cm
!            PARTICLE_MASS = 0.0067D0*(diameter*1.e6/1.0E4)**2.5D0*1.e-3
!         ELSEIF (diameter*1.e6.GT.2.0E4)THEN ! >2cm
!            PARTICLE_MASS = 0.0047D0*(diameter*1.e6/1.0E4)**3.0D0*1.e-3
!         ENDIF
!
...
!        print*, ir,diameter,ndens*del_d, tot_mass/wc*100.,ntot/nc*100.
        ...
        print*, ir,diameter,ndens*del_d, tot_mass/wc*100.,ntot/nc*100., mindex
